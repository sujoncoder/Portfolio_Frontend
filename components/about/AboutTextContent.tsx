...
const AboutTextContent = () => {
  ...
  return (
    <div className="w-full sm:max-w-[60%] space-y-3">
      ...
      <p className="sm:text-lg text-slate-300 pt-4">
        Hey there! 👋 I’m a developer with a 3-year journey in web development. <br /> I've spent almost 1.5 years as a frontend developer at BuddyDevs, working on dynamic and engaging user interfaces. For the past year, I’ve been deeply focused on the MERN stack, enjoying both frontend and backend development.
        <br />
        Check out my
        <button
